...
public class FilesTestData : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        yield return new object[] { "0039.txt" };
        yield return new object[] { "0040.txt" };
        yield return new object[] { "0041.txt" };
        yield return new object[] { "0042.txt" };
        yield return new object[] { "0043.txt" };
        yield return new object[] { "0044.txt" };
        yield return new object[] { "0045.txt" };
        yield return new object[] { "0046.txt" };
        yield return new object[] { "0047.txt" };
        yield return new object[] { "0048.txt" };
        yield return new object[] { "0049.txt" };
        yield return new object[] { "0050.txt" };
        yield return new object[] { "0051.txt" };
        yield return new object[] { "0052.txt" };
        yield return new object[] { "0053.txt" };
        ...
        yield return new object[] { "0060.txt" };
        yield return new object[] { "0061.txt" };
        yield return new object[] { "0062.txt" };
        yield return new object[] { "0063.txt" };
        yield return new object[] { "0064.txt" };
        yield return new object[] { "0065.txt" };
        yield return new object[] { "0066.txt" };
        yield return new object[] { "0067.txt" };
        yield return new object[] { "0068.txt" };
        yield return new object[] { "0069.txt" };
        yield return new object[] { "0070.txt" };
    }
